    ...
    const URL = "https://teachablemachine.withgoogle.com/models/VLyfsODoc/";
    ...
    async function loop(timestamp) {
        ...
        // to hold the last category recieve
        var lastCat = -1;
    ...
    async function predict() {
        ...
        // if its not the same catagory as the last and
        // is assigned (not -1)
        if(topCat!=lastCat && topCat!=-1){

          //if row is max length
          if (rowLength ==rowMax){
            // add new div to label Conainer
            labelContainer.appendChild(document.createElement("div"));
            //add 1 to divNum
            divNum++;
          ...
          // add the top catagory tothe latest divs html
